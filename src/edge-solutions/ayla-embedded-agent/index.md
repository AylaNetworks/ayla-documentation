...
<aside id="pagebar" class="d-xl-block collapse">
  <ul>
    <li><a href="#core-title">Ayla Embedded Agent</a>
      <ul>
    ...
    <li><a href="#ada-client">ADA Client</a></li>
    <li><a href="#property-subsystem">Property Subsystem</a>
      <ul>
    ...
    <li><a href="#simple-table-interface">Simple Table Interface</a>
      <ul>
    ...
    <li><a href="#primitive-interface">Primitive Interface</a>
      <ul>
    ...
    <li><a href="#batch-datapoints">Batch datapoints</a>
      <ul>
    ...
    <li><a href="#ota-updates">OTA updates</a>
      <ul>
    ...
    <li><a href="#command-line-interfaces">Command Line Interfaces</a>
      <ul>
        <li><a href="#cli-functions">CLI functions</a></li>
      </ul>
    </li>
    <li><a href="#required-app-interfaces">Required App Interfaces</a></li>
    <li><a href="#configuration-subsystem">Configuration subsystem</a></li>
    <li><a href="#wi-fi-subsystem">Wi-Fi subsystem</a></li>
  </ul>
</aside>
