...
Run your Aura mobile app, and click the gear icon:

<img src="aura-configuration.png" height="340">

This is the configuration screen. See the Default Configurations and Custom Configurations sections. Each Default Configuration represents a region in the Ayla Public account. Tap a region to point Aura to that particular region. See the configuration for your chosen region at the bottom of the screen:

<img src="aura-configuration-details.png" width="200">

You can also configure Aura to access an Ayla Customer account by creating a Custom Configuration like this:

<ol>
<li>Log into your Ayla Customer Account via the [Ayla Dashboard Portal](http://localhost/apps/ayla-dashboard-portal/).</li>
