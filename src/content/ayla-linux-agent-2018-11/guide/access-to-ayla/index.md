...
The Ayla OEM Account is special. Anyone can create a user account (with limited access rights) in the Ayla OEM Account. If, for example, in the past, you created a user account by clicking <code>Sign Up</code> on the [Ayla Developer Portal](/archive/ayla-developer-portal/), then you have a user account in the publicly available Ayla OEM Account with enough access rights to experiment with the [Ayla Development Kit](/archive/ayla-development-kit). 
...
1. [Ayla Developer Portal](/archive/ayla-developer-portal/)
1. [Ayla Dashboard Portal](/archive/ayla-dashboard-portal/)
...
<li>Log into the [Ayla Dashboard Portal](/archive/ayla-dashboard-portal/).</li>
