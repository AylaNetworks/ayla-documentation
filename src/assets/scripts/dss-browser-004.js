...
$(function() {
  $('#create-event-stream-form').submit(function(event) {
    ...
    let url = 'wss://stream.aylanetworks.com/stream'
...
$(function() {
  $('#select-all-events-btn').click(function(event) {
    $('#dss-events tbody tr td input[type=checkbox]').prop('checked', true)
  })
})
...
$(function() {
  $('#deselect-all-events-btn').click(function(event) {
    $('#dss-events tbody tr td input[type=checkbox]').prop('checked', false)
  })
})
...
$(function() {
  $('#select-all-event-streams-btn').click(function(event) {
    $('#dss-event-streams tbody tr td input[type=checkbox]').prop('checked', true)
  })
})
...
$(function() {
  $('#deselect-all-event-streams-btn').click(function(event) {
    $('#dss-event-streams tbody tr td input[type=checkbox]').prop('checked', false)
  })
})
...
$(function() {
  $("#dss-event-streams").delegate('tr td:not(.chk)', "click", function(e) {
    console.log('Display event stream details.')
    let tr1 = $(this).parent()
    let tr2 = $(tr1).next()
...
$(function() {
  $('#property-value').click(function(event) {
    console.log('on click property-value')
    if ($(this).is(":checked")) {
      console.log('checked')
    } else {
